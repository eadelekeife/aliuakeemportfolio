                ...
                <div className="px-20 py-20">
                    ...
                    <div className="mt-20">
                        <div className="grid grid-cols-2 gap-10">
                            <div>
                                <div className="h-[30rem] w-full bg-[#DCDFE6] rounded-xl mb-5"></div>
                                <h5 className="text-sm mb-2 text-[#969696]">Your Client Name</h5>
                                <h3 className="text-lg">Healthcare Mobile App</h3>
                            </div>
                            <div>
                                <div className="h-[30rem] w-full bg-[#DCDFE6] rounded-xl mb-5"></div>
                                <h5 className="text-sm mb-2 text-[#969696]">Your Client Name</h5>
